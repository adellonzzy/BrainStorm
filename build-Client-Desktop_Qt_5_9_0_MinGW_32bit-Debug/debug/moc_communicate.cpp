...
QT_MOC_LITERAL(5, 34, 17), // "rcvSingleQuestion"
QT_MOC_LITERAL(6, 52, 4), // "Rank"
QT_MOC_LITERAL(7, 57, 8) // "readData"

    },
    "Communicate\0rstResult\0\0login\0json\0"
    "rcvSingleQuestion\0Rank\0readData"
};
...
void Communicate::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->rcvSingleQuestion((*reinterpret_cast< QJsonObject(*)>(_a[1]))); break;
        ...
        {
            typedef void (Communicate::*_t)(QJsonObject );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Communicate::rcvSingleQuestion)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 2
void Communicate::rcvSingleQuestion(QJsonObject _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
